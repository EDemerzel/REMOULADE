...
int main(int argc, char **argv)
{
    ...
    fprintf(stderr, "remoulade init\n");
    fprintf(stderr, "socat openssl:example.com:993 system:'remoulade download'\n");
    fprintf(stderr, "socat openssl:example.com:993 system:'remoulade update'\n");
    fprintf(stderr, "socat openssl:example.com:993 system:'remoulade idle'\n");
    fprintf(stderr, "\n");
    fprintf(stderr, "To disable certificate verification:\n");
    fprintf(stderr, "socat openssl:example.com:993,verify=0 system:'remoulade download'\n");
    fprintf(stderr, "socat openssl:example.com:993,verify=0 system:'remoulade update'\n");
    fprintf(stderr, "socat openssl:example.com:993,verify=0 system:'remoulade idle'\n");
    return 0;
}
